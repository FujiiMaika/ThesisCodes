...
| app
        { $1 }
| TRYD expr WITH LPAREN VAR SEM VAR RPAREN ARROW expr
        { Syntax.TryWithD ($2, $5, $7, $10)  }
| TRYS expr WITH LPAREN VAR SEM VAR RPAREN ARROW expr
        { Syntax.TryWithS ($2, $5, $7, $10)  }
| CALL LPAREN expr RPAREN
        { Syntax.Call ($3) }
